...
function ResultSearch() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      if(locationmap && !elevatormks){        //엘레베이터 받아옴
        $.ajax({
          method: "POST",
          url: "http://203.237.169.237:9000/api/find/incheonElevator",
          async: false,
          data: {
  ...
  return (
    ...
    <div id="test" style={{position: "fixed", top: "0px", zIndex: "0"}}>
    </div>
    <div id="test1" style={{position: "fixed", top: "0px", zIndex: "0"}}>
    </div>
